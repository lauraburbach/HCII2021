...
## Julia
Julia was initially introduced by a group of computer scientists
and mathematicians at MIT under the direction of Alan Edelman.  Compared to other programming languages Julia is considered fast, easy to learn and use and it is open source. 
...
However, with phenomena like opinion dynamics the fluctuating interactions between people appear to be more significant than static variables [@Smith2007;@Vespignani2012].
...
We build the agent based models using either the Julia programming language or version 6.0.4 of the multi-agent programming language Netlogo, which was developed by Uri Wilensky [@Wilensky1999]. For the following analysis of the results we used R Markdown. 
