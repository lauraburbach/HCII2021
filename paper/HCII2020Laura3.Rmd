...
To create agent-based models, Netlogo [@Wilensky1999] is the language most
commonly used. Nevertheless, there are some other programming languages that are
also suitable for creating agent-based models and that seem to be partly more
intuitive, at least for people with programming experience. Therefore, in this
study we compare two programming languages with respect to their suitability for
...
```{r, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Go procedure in Netlogo"), \label{fig:GoNetlogo}, echo=FALSE}
