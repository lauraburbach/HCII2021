...
## Go procedure 
Here we compare the "go" procedures, so what happens in each step of the simulation, of Netlogo and Julia (see Figure 3 and 4). Both codes look similar. In Netlogo (see Figure 4), the procedure starts by adressing the agents (ask turtles)
