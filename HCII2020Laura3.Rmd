...
what influences how messages are spread in online social networks using an agent-based simulation. 
Therefore, we explain what is known in theory about the spread of information and the formation of opinions in this section. We further introduce the latent process model, on which we built our simulation and explain further aspects that are important for the agent-based simulation.
